...
(The capacitance of 2,000'(609m) of this cable is approximately 68,000pF, and the loop resistance of a pair of these stranded 26AWG conductors is 80ohms per 1000').
