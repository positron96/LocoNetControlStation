...
extern dcc::PacketBits idle_packet_bits;
...
public:
    ...
    IDCCChannel(dcc::BasePacketList &packets): packets{packets} {}
    ...
    void sendFunctionGroup(LocoAddress addr, DCCFnGroup group, uint32_t fn);
