# A short memo about DCC packets
...
1111-GGGG 0 DDDD-DDDD 0 DDDD-DDDD - CV access (short)
                                    Allow to write ~6 pre-defined CVs (e.g. CV17+CV18)
...
PPP 0 10AA-AAAA 0 0aaa-1AAT 0 EEEEEEEE 1  - NOP for basic/extended accessory decoder. Ignored by non-RailCom decoders.
                          T               - 0=basic, 1=extended
